...
class DriverApiController extends Controller
{
    ...
    public function driver_registration(Request $request)
    {
        ...
        try {
            ...
            $DriverProfile =  DriverProfile::create(['user_id' => $user_id, 'birth_date' => $request->birth_date,  'id_number' => $request->id_number,   'criminal_record_image' => $criminal_record_image['image'],]);
            ...
            $DriverLicense =  DriverLicense::create(['front_license_image' =>  $front_license_image['image'],   'back_license_image' => $back_license_image['image'], 'driver_with_license_image' => $driver_with_license_image['image'],    'expiry_date' => $request->expiry_date, 'driver_profile_id' => $DriverProfile->id]);
