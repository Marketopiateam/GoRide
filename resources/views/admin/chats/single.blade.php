    ...
    <div class="row g-0">
        ...
        <div class="col app-chat-sidebar-left app-sidebar overflow-hidden" id="app-chat-sidebar-left">
            ...
            <div class="sidebar-body px-4 pb-4 ps ps--active-y">
                ...
                <div class="d-flex mt-4">
                    <button class="btn btn-primary waves-effect waves-light" data-bs-toggle="sidebar" data-overlay=""
        ...
        <div class="col app-chat-contacts app-sidebar flex-grow-0 overflow-hidden border-end" id="app-chat-contacts">
            ...
            <div class="sidebar-body ps ps--active-y">
                ...
                <div class="ps__rail-y" style="top: 0px; height: 498px; right: 0px;">
                    <div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 244px;"></div>
                </div>
            </div>
        </div>
        <!-- /Chat contacts -->
        ...
        <div class="col app-chat-history bg-body">
            <div class="chat-history-wrapper">
                ...
                <div class="chat-history-body bg-body ps ps--active-y">
                        ...
                        <li class="chat-message chat-message-right">
                            <div class="d-flex overflow-hidden">
                                <div class="chat-message-wrapper flex-grow-1 w-50">
                                    <div class="chat-message-text">
                                        <p class="mb-0">
                                            Yes that's correct documentation file, Design files are included with the
                                            template.
                                        </p>
                                    </div>
                                    <div class="text-end text-muted mt-1">
                    ...
                    <div class="ps__rail-x" style="left: 0px; bottom: -708px;">
                        <div class="ps__thumb-x" tabindex="0" style="left: 0px; width: 0px;"></div>
                    </div>
                    <div class="ps__rail-y" style="top: 708px; height: 410px; right: 0px;">
                        <div class="ps__thumb-y" tabindex="0" style="top: 260px; height: 150px;"></div>
                    </div>
                </div>
                <!-- Chat message form -->
        ...
        <div class="col app-chat-sidebar-right app-sidebar overflow-hidden" id="app-chat-sidebar-right">
            ...
            <div class="sidebar-body px-4 pb-4 ps ps--active-y">
                ...
                <div class="ps__rail-y" style="top: 0px; height: 366px; right: 0px;">
